"""
Django settings for EMR_tool project.
...
SECRET_KEY = 'django-insecure-vkd^q%m2l98p#^#nf$l(ts+al5_@hd7kicke(=jcu_@wg&0mf@'
...
WSGI_APPLICATION = 'EMR_tool.wsgi.application'
